...
import com.demo.product.review.security.rest.LoginFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.exceptionHandling().authenticationEntryPoint(restAuthenticationEntryPoint)
				...
				.antMatchers("/images/**").permitAll().antMatchers(HttpMethod.POST,"/api/user/login").permitAll()
				.antMatchers("/api/user/add").permitAll().anyRequest().authenticated().and()
